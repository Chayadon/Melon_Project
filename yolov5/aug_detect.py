...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            seen += 1
            is_BB_empty = True
            parent_dir = "/home/leaf/Documents/melProject/yolov5/Aug/"  # Edit Here
...
def ResizeImage(imageName, p):
    path_to_save = "/home/leaf/Documents/melProject/yolov5/Aug/"  # images are saved #Edit Here
...
def Label_Collector(txt, namefile):
    path_of_file = "/home/leaf/Documents/melProject/yolov5/Aug/" + namefile + ".txt"  # Edit Here
...
def BoundingBox(xy, NameOfFile):
    print(NameOfFile)
    path_of_file = "/home/leaf/Documents/melProject/yolov5/Aug/" + \
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str,
                        default=ROOT / '/home/leaf/Documents/melProject/yolov5/runs/train/exp/weights/best1.pt', help='model path(s)')
